...
package iqb.jps.core.wrapper;

import com.fasterxml.jackson.annotation.JsonAutoDetect;

import iqb.jps.core.JsonTool;
import iqb.jps.core.UncheckedJsonException;
import tools.jackson.databind.json.JsonMapper;

/**
 * Wrapper implementation of the JsonTool interface using Jackson for JSON.
 */
public class JacksonJsonToolImpl implements JsonTool {

    private final JsonMapper jsonMapper;

    private static final JsonTool instance = new JacksonJsonToolImpl();
    public static final JsonTool Instance(){
        return instance;
    }    

    private JacksonJsonToolImpl() {
